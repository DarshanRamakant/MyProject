...
CREATE TABLE USER_PROF_DETAILS ( USER_ID INTEGER UNSIGNED NOT NULL,  USER_NAME VARCHAR(100), PROFILE_PIC LONGBLOB, GENDER VARCHAR(1),COURSE_ID INTEGER UNSIGNED NOT NULL, PHONE_NO VARCHAR(10), FOREIGN KEY (USER_ID) REFERENCES USER_ID_MAP(USER_ID),FOREIGN KEY (COURSE_ID) REFERENCES COURSE(COURSE_ID)); 
