...
CREATE TABLE USER_POST_DETAILS ( USER_ID INTEGER UNSIGNED NOT NULL,POST_CONTENT VARCHAR(255), POST_TIMESTAMP TIMESTAMP DEFAULT CURRENT_TIMESTAMP,PRIMARY KEY (USER_ID), FOREIGN KEY (USER_ID) REFERENCES USER_ID_MAP(USER_ID));
